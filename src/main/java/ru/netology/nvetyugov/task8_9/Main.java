...
import ru.netology.nvetyugov.task7.model.operations.CashbackOperation;
import ru.netology.nvetyugov.task7.model.operations.LoanOperation;
...
public class Main {
    ...
    private void loadOperationData(){
        try {
            ...
            projectRepository.setOperationData(operationData);
        } catch (ReadDataFromFileException e){
            System.out.println("Файл ещё ни разу не был сохранен");
        }
    }
    private void saveOperationData(){
        serializationService.writeDataToFile(PATH_TO_SAVE_DATA, projectRepository.getOperationData());
    }
